...
resource "aws_autoscaling_group" "web-asg" {
  ...
  vpc_zone_identifier  = "${var.env}" == "prod" ? [data.aws_subnet.subnet-private-1.id, data.aws_subnet.subnet-private-2.id, data.aws_subnet.subnet-private-3.id] : [data.aws_subnet.subnet-private-1.id]
...
resource "aws_elb" "web-elb" {
  name            = "${var.env}-elb"
  subnets         = [data.aws_subnet.subnet-public-1.id, data.aws_subnet.subnet-public-2.*.id[count.index], data.aws_subnet.subnet-public-3.*.id[count.index]]
